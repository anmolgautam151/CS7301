...
public class Log {
	public static void logFieldAcc(String o, String name, final boolean isStatic, final boolean isWrite)
	{
		//System.out.println("Thread "+Thread.currentThread().getName() + " static field "+name + " Object" + o);
		if(isStatic)
